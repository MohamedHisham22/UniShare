...
class ChangingLnameView extends StatelessWidget {
  ChangingLnameView({super.key});
  static final String id = 'ChangingLname';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<UpdateProfileCubit, UpdateProfileState>(
      listener: (context, state) {
        if (state is ChanginglNameFailed) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(state.messege)));
        } else if (state is ChanginglNameSuccess) {
          AwesomeDialog(
            context: context,
            dialogType: DialogType.success,
            animType: AnimType.scale,
            title: 'Success!',
            desc: 'Your Last Name Has been Updated Successfully!',
            btnOkOnPress: () {
      ...
      builder: (context, state) {
        return ModalProgressHUD(
          inAsyncCall: state is ChanginglNameLoading,
          child: Scaffold(
            appBar: AppBar(
